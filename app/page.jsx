    ...
    <div className="w-full">
    {
      !loading ?
        <div className="grid w-full grid-cols lg:grid-cols-4 flex gap-4">
          <aside className="hidden sticky top-[5rem] lg:block px-6 rounded-md mt-2 mb-2 h-[90vh] py-5 bg-gray-900">
          ...
          <div className="lg:col-span-2">
            <div className="px-4 py-4 bg-gradient-to-t from-gray-900 to-gray-800 mt-[1.5rem] rounded-md">
              <div className="w-full">
                ...
                <form
                  ...
                  <textarea required value={titlePost} onChange={(e) => changeTitle(e.target.value)} rows="5" className="focus:border-gray-500 focus:text-gray-200 focus:outline-none block p-2.5 w-full text-sm text-gray-500 bg-gray-800 rounded-lg border border-gray-600" placeholder="Escribe lo que piensas..."></textarea>
          ...
          <aside className="z-0 overflow-auto hidden lg:block sticky h-[90vh] bg-gray-900 mt-2 py-5 px-5 top-[5rem] rounded-lg ">
